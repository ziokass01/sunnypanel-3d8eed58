...
// Mozilla CA bundle in PEM format (generated for libcurl/OpenSSL)
// Source: TeX Live curl-ca-bundle.crt (Mozilla trust store) - dated Dec 2, 2025
static const char SUNNY_CA_BUNDLE_PEM[] = R"PEM(
##
