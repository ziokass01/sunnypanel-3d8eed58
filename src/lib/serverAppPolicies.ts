...
export const FIND_DUMPS_UNLOCKS: FeatureUnlockPolicy[] = [
  {
    ...
    premiumUnlockCost: 1,
    softUnlockCost7d: 6,
    premiumUnlockCost7d: 3,
    softUnlockCost30d: 18,
    premiumUnlockCost30d: 9,
    freePlans: ["pro"],
    renewable: true,
    enabled: true,
  },
  {
    ...
    softUnlockCost7d: 3,
    premiumUnlockCost7d: 1.5,
    softUnlockCost30d: 9,
    premiumUnlockCost30d: 4,
    freePlans: ["plus", "pro"],
    renewable: true,
    enabled: true,
  },
  {
    ...
    softUnlockCost7d: 1.5,
    premiumUnlockCost7d: 0.6,
    softUnlockCost30d: 4,
    premiumUnlockCost30d: 1.8,
