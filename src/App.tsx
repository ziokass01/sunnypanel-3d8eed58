...
import AdminRentPage from "@/pages/AdminRent";
import TenantRoute from "@/auth/TenantRoute";
import RentShell from "@/shell/RentShell";
import RentLoginPage from "@/pages/RentLogin";
import RentResetPasswordPage from "@/pages/RentResetPassword";
import RentDashboardPage from "@/pages/RentDashboard";
import RentKeysPage from "@/pages/RentKeys";
import RentIntegrationPage from "@/pages/RentIntegration";

const queryClient = new QueryClient();

const App = () => {
  const isAdminHost = typeof window !== "undefined" && window.location.hostname.toLowerCase().startsWith("admin.");
            ...
            <Routes>
              {isAdminHost ? (
                ...
                <>
                  ...
                  <Route path="/login" element={<RentLoginPage />} />
                  <Route path="/reset-password" element={<RentResetPasswordPage />} />
