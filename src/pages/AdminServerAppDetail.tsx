...
const FEATURE_TEMPLATES: Record<string, ServerAppFeatureRow[]> = {
  "find-dumps": [
    ...
    { app_code: "find-dumps", feature_code: "binary_scan_quick", title: "Binary scan quick", description: "Quét nhanh ELF/.so để lấy header, section, symbol và string cơ bản", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 80, category: "binary", group_key: "scan", icon_key: "binary", badge_label: "Binary", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "binary_scan_full", title: "Binary scan full", description: "Quét sâu Binary Workspace và dựng function intelligence", enabled: true, min_plan: "go", requires_credit: true, soft_cost: 2, premium_cost: 1, reset_period: "daily", sort_order: 90, category: "binary", group_key: "scan", icon_key: "binary", badge_label: "Binary", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "ida_export_import", title: "Import IDA / artifact", description: "Nạp artifact từ IDA, r2 hoặc disassembly ngoài", enabled: true, min_plan: "go", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 100, category: "binary", group_key: "artifact", icon_key: "import", badge_label: "Artifact", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "ida_workspace_save", title: "Save workspace", description: "Lưu snapshot workspace để mở lại lần sau", enabled: true, min_plan: "classic", requires_credit: false, soft_cost: 0, premium_cost: 0, reset_period: "daily", sort_order: 110, category: "binary", group_key: "workspace", icon_key: "save", badge_label: "Workspace", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "ida_workspace_export", title: "Export workspace", description: "Xuất workspace hoặc bundle ra file ngoài", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 120, category: "binary", group_key: "workspace", icon_key: "export", badge_label: "Export", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "ida_workspace_restore", title: "Restore workspace", description: "Khôi phục workspace đã lưu từ storage hoặc import file", enabled: true, min_plan: "classic", requires_credit: false, soft_cost: 0, premium_cost: 0, reset_period: "daily", sort_order: 130, category: "binary", group_key: "workspace", icon_key: "restore", badge_label: "Workspace", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "workspace_batch", title: "Workspace batch", description: "Chạy batch query trên Binary Workspace", enabled: true, min_plan: "go", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 140, category: "binary", group_key: "workspace", icon_key: "batch", badge_label: "Batch", visible_to_guest: true, charge_unit: 5, charge_on_success_only: true, client_accumulate_units: true },
    { app_code: "find-dumps", feature_code: "workspace_note", title: "Workspace note", description: "Gắn note hoặc tag cho entry trong workspace", enabled: true, min_plan: "classic", requires_credit: false, soft_cost: 0, premium_cost: 0, reset_period: "daily", sort_order: 150, category: "binary", group_key: "workspace", icon_key: "note", badge_label: "Workspace", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "workspace_export_result", title: "Workspace export result", description: "Xuất current view hoặc current result từ Binary Workspace", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 160, category: "binary", group_key: "workspace", icon_key: "export", badge_label: "Export", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "workspace_browser", title: "Workspace browser", description: "Mở browser/xref/pseudo trong Binary Workspace", enabled: true, min_plan: "plus", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 170, category: "binary", group_key: "workspace", icon_key: "browser", badge_label: "Browser", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "workspace_diff", title: "Workspace diff", description: "So sánh 2 workspace hoặc 2 phiên dump", enabled: true, min_plan: "plus", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 180, category: "binary", group_key: "workspace", icon_key: "diff", badge_label: "Diff", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "diff_two_dumps", title: "Diff 2 dump", description: "So sánh dump cũ và dump mới theo phase 2 của app", enabled: true, min_plan: "plus", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 190, category: "migration", group_key: "diff", icon_key: "diff", badge_label: "Phase 2", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "query_remap", title: "Query remap", description: "Remap query từ dump cũ sang dump mới theo phase 2 của app", enabled: true, min_plan: "plus", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 200, category: "migration", group_key: "remap", icon_key: "remap", badge_label: "Phase 2", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "batch_migrate", title: "Batch migrate", description: "Batch migrate nhiều query và anchor", enabled: true, min_plan: "pro", requires_credit: true, soft_cost: 2, premium_cost: 1, reset_period: "daily", sort_order: 210, category: "migration", group_key: "batch", icon_key: "batch", badge_label: "Phase 2+", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "batch_compare", title: "Batch compare", description: "Compare nhiều query hoặc nhiều bản dump", enabled: true, min_plan: "pro", requires_credit: true, soft_cost: 2, premium_cost: 1, reset_period: "daily", sort_order: 220, category: "migration", group_key: "batch", icon_key: "batch", badge_label: "Phase 2+", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "batch_validate", title: "Batch validate", description: "Validate anchor và rule sau migrate", enabled: true, min_plan: "pro", requires_credit: true, soft_cost: 2, premium_cost: 1, reset_period: "daily", sort_order: 230, category: "migration", group_key: "batch", icon_key: "batch", badge_label: "Phase 2+", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    { app_code: "find-dumps", feature_code: "export_report", title: "Export report", description: "Xuất báo cáo migration/diff ra ngoài", enabled: true, min_plan: "pro", requires_credit: true, soft_cost: 1, premium_cost: 1, reset_period: "daily", sort_order: 240, category: "migration", group_key: "export", icon_key: "report", badge_label: "Phase 2+", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
  ],
  "free-fire": [
...
export function AdminServerAppDetailPage() {
  ...
  const openExternal = () => {
    if (appCode === "find-dumps") {
      const keysPath = buildWorkspacePath(appCode, "keys", workspaceScope, "", "", location.pathname);
      window.location.assign(keysPath);
      return;
    }
