...
const PLAN_TEMPLATES: Record<string, ServerAppPlanRow[]> = {
  "find-dumps": [
    ...
    { app_code: "find-dumps", plan_code: "go", label: "Go", enabled: true, daily_soft_credit: 12, daily_premium_credit: 1, soft_cost_multiplier: 0.88, premium_cost_multiplier: 0.88, device_limit: 1, account_limit: 1, sort_order: 20 },
    { app_code: "find-dumps", plan_code: "plus", label: "Plus", enabled: true, daily_soft_credit: 60, daily_premium_credit: 8, soft_cost_multiplier: 0.55, premium_cost_multiplier: 0.55, device_limit: 2, account_limit: 1, sort_order: 30 },
    { app_code: "find-dumps", plan_code: "pro", label: "Pro", enabled: true, daily_soft_credit: 200, daily_premium_credit: 30, soft_cost_multiplier: 0.30, premium_cost_multiplier: 0.30, device_limit: 3, account_limit: 1, sort_order: 40 },
  ],
  "free-fire": [
...
const FEATURE_TEMPLATES: Record<string, ServerAppFeatureRow[]> = {
  "find-dumps": [
    ...
    { app_code: "find-dumps", feature_code: "batch_search", title: "Batch search", description: "Tìm nhiều dòng trong 1 file truy vấn", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.1, premium_cost: 0.05, reset_period: "daily", sort_order: 20, category: "search", group_key: "batch", icon_key: "batch", badge_label: "Tính theo cụm", visible_to_guest: true, charge_unit: 10, charge_on_success_only: true, client_accumulate_units: true },
    ...
    { app_code: "find-dumps", feature_code: "export_json", title: "Export JSON", description: "Xuất kết quả dạng JSON", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.3, premium_cost: 0.15, reset_period: "daily", sort_order: 30, category: "export", group_key: "result", icon_key: "json", badge_label: "JSON", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    ...
    { app_code: "find-dumps", feature_code: "game_profiles", title: "Game Profiles", description: "Lưu, import, export và quét nhiều offset theo profile", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.25, premium_cost: 0.12, reset_period: "daily", sort_order: 45, category: "tools", group_key: "profile", icon_key: "profile", badge_label: "Tính credit", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
    ...
    { app_code: "find-dumps", feature_code: "convert_image", title: "Convert image", description: "Đổi ảnh sang header .h", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.2, premium_cost: 0.1, reset_period: "daily", sort_order: 50, category: "tools", group_key: "image", icon_key: "image", badge_label: "5 lượt / 1 credit", visible_to_guest: true, charge_unit: 5, charge_on_success_only: true, client_accumulate_units: true },
    { app_code: "find-dumps", feature_code: "encode_decode", title: "Encode / Decode", description: "Bộ codec kiểu toolbox", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.1, premium_cost: 0.05, reset_period: "daily", sort_order: 60, category: "tools", group_key: "codec", icon_key: "codec", badge_label: "10 lượt / 1 credit", visible_to_guest: true, charge_unit: 10, charge_on_success_only: true, client_accumulate_units: true },
    { app_code: "find-dumps", feature_code: "hex_edit", title: "Hex edit", description: "Mở file và sửa hex rồi lưu", enabled: true, min_plan: "classic", requires_credit: true, soft_cost: 0.3, premium_cost: 0.15, reset_period: "daily", sort_order: 70, category: "tools", group_key: "hex", icon_key: "hex", badge_label: "Tính credit", visible_to_guest: true, charge_unit: 1, charge_on_success_only: true, client_accumulate_units: false },
  ],
  "free-fire": [
