...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (action === "hard_delete_session" || action === "delete_session" || action === "purge_session") {
    ...
    if (action === "hard_delete_entitlement" || action === "delete_entitlement" || action === "purge_entitlement") {
